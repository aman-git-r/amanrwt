...
export const SKILLS: Record<SkillId, Skill> = {
    ...
    shadcn: { id: 'shadcn', name: 'Shadcn', Icon: SiShadcnui, color: '#000000', url: 'https://shadcn.com' },
    ...
    sass: { id: 'sass', name: 'Sass', Icon: SiSass, color: '#CC6699', url: 'https://sass-lang.com' },
    ...
    drf: { id: 'drf', name: 'Django REST Framework', Icon: SiDjango, color: '#092E20', url: 'https://www.django-rest-framework.org' },
